...
Audit a single page or sample your whole site with `--pages`, persist settings in a [config file](/docs/configuration), and wire the results into CI with `--fail-on` and baselines. See what changed in [v0.3.0](/changelog/v0-3-0).
